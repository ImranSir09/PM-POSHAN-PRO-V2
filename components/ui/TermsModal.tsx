...
const TermsModal: React.FC<TermsModalProps> = ({ isOpen, onClose }) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Terms and Conditions" zIndex="z-[60]">
            <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 text-sm text-slate-600 dark:text-slate-300">
                <p className="text-xs text-slate-500 dark:text-slate-400">Last Updated: {new Date().toLocaleDateString('en-IN')}</p>
                <p>Please read these Terms and Conditions ("Terms") carefully before using the PM POSHAN Tracker application (the "Service").</p>
                
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">1. Acceptance of Terms</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">2. Description of Service</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">3. Data Privacy and Storage</h4>
                <p>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">4. User Account and Security</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">5. User Responsibilities</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">6. Disclaimer of Warranties</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">7. Limitation of Liability</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">8. Changes to Terms</h4>
                ...
                <h4 className="font-semibold text-slate-800 dark:text-slate-200">9. Contact Information</h4>
            ...
            <div className="mt-6 text-right border-t border-slate-100 dark:border-slate-800 pt-4">
